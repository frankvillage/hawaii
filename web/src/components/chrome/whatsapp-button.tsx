...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-40 inline-flex h-13 w-13 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_30px_rgba(0,0,0,0.35)] transition hover:-translate-y-0.5 hover:bg-[#2ee275] sm:bottom-6 sm:right-6"
      style={{ width: "3.25rem", height: "3.25rem" }}
    >
      <svg viewBox="0 0 32 32" width="26" height="26" aria-hidden fill="#ffffff">
